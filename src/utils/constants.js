...
export const LOGO_URL =
  "https://firebasestorage.googleapis.com/v0/b/obra-nova-spa.firebasestorage.app/o/logo.png?alt=media";
...
export const ESTADOS = ["Borrador", "Enviado", "Aceptado", "Rechazado"];
